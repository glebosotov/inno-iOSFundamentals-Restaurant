...
class OrderTableViewController: UITableViewController {
    ...
    @IBSegueAction func confirmOrder(_ coder: NSCoder) -> OrderConformationViewController? {
        return OrderConformationViewController(coder: coder, minutesToPrepare: minutesToPrepareOrder)
    }
    ...
    override func viewWillDisappear(_ animated: Bool) {
        imageLoadTasks.forEach {k, v in v.cancel() }
    }
